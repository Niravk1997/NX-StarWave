...
{
    public class Channel_10_Node_ViewModel : Node_ViewModel
    {
        ...
        public Channel_10_Node_ViewModel(object Parent_Window, string Name, bool IsCollapsed, NodeCategory Category, string Background_Color, string Foreground_Color)
        {
        ...
        static Channel_10_Node_ViewModel()
        {
            Splat.Locator.CurrentMutable.Register(() => new Channel_10_Node_View(), typeof(IViewFor<Channel_10_Node_ViewModel>));
        }
    }
}
