...
namespace YT_Node
{
    public partial class YT_Inputs_1_ViewModel : Node_ViewModel
    {
        ...
        public YT_Inputs_1_ViewModel(object Parent_Window, string Name, bool IsCollapsed, NodeCategory Category, string Background_Color, string Foreground_Color, string Units, string Input_1_Name = "Input 1", string Input_1_Color = "#0072BD")
        {
            ...
            this.WhenAnyValue(vm => vm.Input_1.Value).Subscribe(value => { if (value != null) { Output_to_YT(value); } });
        ...
        private void Output_to_YT(Node_Waveform_Model Input_1)
        {
        ...
        static YT_Inputs_1_ViewModel()
        {
            Splat.Locator.CurrentMutable.Register(() => new YT_Inputs_1_View(), typeof(IViewFor<YT_Inputs_1_ViewModel>));
        }
    }
}
