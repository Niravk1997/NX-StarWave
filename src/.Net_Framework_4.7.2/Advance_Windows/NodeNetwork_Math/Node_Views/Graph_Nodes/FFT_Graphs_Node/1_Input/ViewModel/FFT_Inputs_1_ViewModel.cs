...
namespace FFT_Node
{
    public partial class FFT_Inputs_1_ViewModel : Node_ViewModel
    {
        ...
        public FFT_Inputs_1_ViewModel(object Parent_Window, string Name, bool IsCollapsed, NodeCategory Category, string Background_Color, string Foreground_Color, string Units, string Input_1_Name = "Input 1", string Input_1_Color = "#0072BD")
        {
            ...
            this.WhenAnyValue(vm => vm.Input_1.Value).Subscribe(value => { if (value != null) { Output_to_FFT(value); } });
        ...
        private void Output_to_FFT(Node_Waveform_Model Input_1)
        {
        ...
        static FFT_Inputs_1_ViewModel()
        {
            Splat.Locator.CurrentMutable.Register(() => new FFT_Inputs_1_View(), typeof(IViewFor<FFT_Inputs_1_ViewModel>));
        }
    }
}
