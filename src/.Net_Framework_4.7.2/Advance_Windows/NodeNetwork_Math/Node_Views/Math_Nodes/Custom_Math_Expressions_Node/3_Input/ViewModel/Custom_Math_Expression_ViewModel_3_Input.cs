...
{
    public partial class Custom_Math_Expression_ViewModel_3_Input : Node_ViewModel
    {
        ...
        public Custom_Math_Expression_ViewModel_3_Input(object Parent_Window, string Name, bool IsCollapsed, NodeCategory Category, string Background_Color, string Foreground_Color, string Units, string Library_Type, string Math_Expression, string Output_Name = "Output", string Input_1_Name = "x1", string Input_2_Name = "x2", string Input_3_Name = "x3")
        {
            ...
            {
                Math_Expression_Parse = new mXparser_Expression_Parser(Math_Expression, Output_Name, Input_1_Name, Input_2_Name, Input_3_Name);
            }
            else
            {
                Math_Expression_Parse = new MathNET_Symbolics_Expression_Parser(Math_Expression, Output_Name, Input_1_Name, Input_2_Name, Input_3_Name);
                Library_Speed = "Fast";
            }
            ...
            {
                Name = Output_Name,
                Value = this.WhenAnyValue(vm => vm.Input_1.Value, vm => vm.Input_2.Value, vm => vm.Input_3.Value).Select(value => value.Item1 != null && value.Item2 != null && value.Item3 != null ? Input_Verification(value.Item1, value.Item2, value.Item3) : Return_Old_Output())
            };
        ...
        private Node_Waveform_Model Input_Verification(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3)
        {
            if (Check_Data_Points_Match(Input_1, Input_2, Input_3) && Check_Total_Time_Match(Input_1, Input_2, Input_3))
            {
                if (Input_1.Unique_ID != Input_1_Unique_Key && Input_2.Unique_ID != Input_2_Unique_Key && Input_3.Unique_ID != Input_3_Unique_Key)
                {
                    Input_1_Unique_Key = Input_1.Unique_ID;
                    Input_2_Unique_Key = Input_2.Unique_ID;
                    Input_3_Unique_Key = Input_3.Unique_ID;
                    return Perform_Math_Operation(Input_1, Input_2, Input_3);
                }
        ...
        private bool Check_Data_Points_Match(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3)
        {
            if (Input_1.Data_points == Input_2.Data_points && Input_2.Data_points == Input_3.Data_points)
            {
                return true;
            }
            else
        ...
        private bool Check_Total_Time_Match(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3)
        {
            if (Input_1.Total_Time == Input_2.Total_Time && Input_2.Total_Time == Input_3.Total_Time)
            {
                return true;
            }
            else
        ...
        private Node_Waveform_Model Perform_Math_Operation(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3)
        {
            (bool isValid, int Infinity_Count, int NAN_Count, int Min_Count, int Max_Count, string Message, double[] Results) = Math_Expression_Parse.Compute_Expression(Input_1, Input_2, Input_3);
            ...
            if (isValid)
            {
                return Final_Results(Input_1, Input_2, Input_3, Results);
            }
            else
            {
        ...
        private Node_Waveform_Model Final_Results(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3, double[] Results)
        {
        ...
        static Custom_Math_Expression_ViewModel_3_Input()
        {
            Splat.Locator.CurrentMutable.Register(() => new Custom_Math_Expression_View_3_Input(), typeof(IViewFor<Custom_Math_Expression_ViewModel_3_Input>));
        }
    }
}
