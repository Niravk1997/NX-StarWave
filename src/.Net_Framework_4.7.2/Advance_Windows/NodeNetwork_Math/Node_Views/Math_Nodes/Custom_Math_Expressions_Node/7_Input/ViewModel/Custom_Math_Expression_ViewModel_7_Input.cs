...
{
    public partial class Custom_Math_Expression_ViewModel_7_Input : Node_ViewModel
    {
        ...
        private int Input_7_Unique_Key = -1;
        ...
        public ValueNodeInputViewModel<Node_Waveform_Model> Input_7 { get; }
        ...
        private string Input_7_string_ = "x7";
        public string Input_7_string
        {
            get => Input_7_string_;
            set => this.RaiseAndSetIfChanged(ref Input_7_string_, value);
        }
        ...
        public Custom_Math_Expression_ViewModel_7_Input(object Parent_Window, string Name, bool IsCollapsed, NodeCategory Category, string Background_Color, string Foreground_Color, string Units, string Library_Type, string Math_Expression, string Output_Name = "Output", string Input_1_Name = "x1", string Input_2_Name = "x2", string Input_3_Name = "x3", string Input_4_Name = "x4", string Input_5_Name = "x5", string Input_6_Name = "x6", string Input_7_Name = "x7")
        {
            ...
            this.Input_7_string = Input_7_Name;

            Math_Expression_Parse = new mXparser_Expression_Parser(Math_Expression, Output_Name, Input_1_Name, Input_2_Name, Input_3_Name, Input_4_Name, Input_5_Name, Input_6_Name, Input_7_Name);
            ...
            Input_7 = new ValueNodeInputViewModel<Node_Waveform_Model>()
            {
                Name = Input_7_Name
            };
            this.Inputs.Add(Input_7);

            Output = new ValueNodeOutputViewModel<Node_Waveform_Model>()
            {
                Name = Output_Name,
                Value = this.WhenAnyValue(vm => vm.Input_1.Value, vm => vm.Input_2.Value, vm => vm.Input_3.Value, vm => vm.Input_4.Value, vm => vm.Input_5.Value, vm => vm.Input_6.Value, vm => vm.Input_7.Value).Select(value => value.Item1 != null && value.Item2 != null && value.Item3 != null && value.Item4 != null && value.Item5 != null && value.Item6 != null && value.Item7 != null ? Input_Verification(value.Item1, value.Item2, value.Item3, value.Item4, value.Item5, value.Item6, value.Item7) : Return_Old_Output())
            };
        ...
        private Node_Waveform_Model Input_Verification(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3, Node_Waveform_Model Input_4, Node_Waveform_Model Input_5, Node_Waveform_Model Input_6, Node_Waveform_Model Input_7)
        {
            if (Check_Data_Points_Match(Input_1, Input_2, Input_3, Input_4, Input_5, Input_6, Input_7) && Check_Total_Time_Match(Input_1, Input_2, Input_3, Input_4, Input_5, Input_6, Input_7))
            {
                if (Input_1.Unique_ID != Input_1_Unique_Key && Input_2.Unique_ID != Input_2_Unique_Key && Input_3.Unique_ID != Input_3_Unique_Key && Input_4.Unique_ID != Input_4_Unique_Key && Input_5.Unique_ID != Input_5_Unique_Key && Input_6.Unique_ID != Input_6_Unique_Key && Input_7.Unique_ID != Input_7_Unique_Key)
                {
                    ...
                    Input_7_Unique_Key = Input_7.Unique_ID;
                    return Perform_Math_Operation(Input_1, Input_2, Input_3, Input_4, Input_5, Input_6, Input_7);
                }
                else if (NodeEditor_Global_Config.Update_When_Some_Inputs_Update == true)
                {
                    ...
                    else if (Input_7.Unique_ID != Input_7_Unique_Key)
                    {
                        Input_7_Unique_Key = Input_7.Unique_ID;
                        return Perform_Math_Operation(Input_1, Input_2, Input_3, Input_4, Input_5, Input_6, Input_7);
                    }
        ...
        private Node_Waveform_Model Perform_Math_Operation(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3, Node_Waveform_Model Input_4, Node_Waveform_Model Input_5, Node_Waveform_Model Input_6, Node_Waveform_Model Input_7)
        {
            (bool isValid, int Infinity_Count, int NAN_Count, int Min_Count, int Max_Count, string Message, double[] Results) = Math_Expression_Parse.Compute_Expression(Input_1, Input_2, Input_3, Input_4, Input_5, Input_6, Input_7);
            ...
            if (isValid)
            {
                return Final_Results(Input_1, Input_2, Input_3, Input_4, Input_5, Input_6, Input_7, Results);
            }
            else
            {
        ...
        private Node_Waveform_Model Final_Results(Node_Waveform_Model Input_1, Node_Waveform_Model Input_2, Node_Waveform_Model Input_3, Node_Waveform_Model Input_4, Node_Waveform_Model Input_5, Node_Waveform_Model Input_6, Node_Waveform_Model Input_7, double[] Results)
        {
            ...
            switch (Primary_Input)
            {
                ...
                case 6:
                    ...
                    return Waveform_Data;
                case 7:
                    Waveform_Data = new Node_Waveform_Model(Input_7.Unique_ID, Input_7.Data_points, Input_7.Total_Time, Input_7.Start_Time, Input_7.Stop_Time, Input_7.X_Values, Results, Units);
                    Insert_New_Results_into_Graph(Waveform_Data);
                    return Waveform_Data;
                default:
                    Waveform_Data = new Node_Waveform_Model(Input_1.Unique_ID, Input_1.Data_points, Input_1.Total_Time, Input_1.Start_Time, Input_1.Stop_Time, Input_1.X_Values, Results, Units);
        ...
        static Custom_Math_Expression_ViewModel_7_Input()
        {
            Splat.Locator.CurrentMutable.Register(() => new Custom_Math_Expression_View_7_Input(), typeof(IViewFor<Custom_Math_Expression_ViewModel_7_Input>));
        }
    }
}
