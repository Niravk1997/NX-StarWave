...
namespace Custom_Math_Expressions_Node
{
    public partial class Custom_Math_Expression_ViewModel_2_Input : Node_ViewModel
    {
        ...
        public Custom_Math_Expression_ViewModel_2_Input(object Parent_Window, string Name, bool IsCollapsed, NodeCategory Category, string Background_Color, string Foreground_Color, string Units, string Library_Type, string Math_Expression, string Output_Name = "Output", string Input_1_Name = "x1", string Input_2_Name = "x2")
        {
            ...
            {
                Math_Expression_Parse = new mXparser_Expression_Parser(Math_Expression, Output_Name, Input_1_Name, Input_2_Name);
            }
            else
            {
                Math_Expression_Parse = new MathNET_Symbolics_Expression_Parser(Math_Expression, Output_Name, Input_1_Name, Input_2_Name);
                Library_Speed = "Fast";
            }
        ...
        {
            (bool isValid, int Infinity_Count, int NAN_Count, int Min_Count, int Max_Count, string Message, double[] Results) = Math_Expression_Parse.Compute_Expression(Input_1, Input_2);
        ...
        static Custom_Math_Expression_ViewModel_2_Input()
        {
            Splat.Locator.CurrentMutable.Register(() => new Custom_Math_Expression_View_2_Input(), typeof(IViewFor<Custom_Math_Expression_ViewModel_2_Input>));
        }
    }
}
