...
namespace NodeNetwork_Math
{
    public partial class NodeNetwork_Window : MetroWindow
    {
        ...
        public void Add_Custom_Math_Expression_Node_depending_on_Total_Inputs(Custom_Math_Expression_Node_Data Custom_Math_Expression_Node)
        {
            ...
            {
                case 0:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_1_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1));
                    break;
                case 1:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_2_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1, Custom_Math_Expression_Node.X2));
                    break;
                case 2:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_3_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1, Custom_Math_Expression_Node.X2, Custom_Math_Expression_Node.X3));
                    break;
                case 3:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_4_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1, Custom_Math_Expression_Node.X2, Custom_Math_Expression_Node.X3, Custom_Math_Expression_Node.X4));
                    break;
                case 4:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_5_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1, Custom_Math_Expression_Node.X2, Custom_Math_Expression_Node.X3, Custom_Math_Expression_Node.X4, Custom_Math_Expression_Node.X5));
                    break;
                case 5:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_6_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1, Custom_Math_Expression_Node.X2, Custom_Math_Expression_Node.X3, Custom_Math_Expression_Node.X4, Custom_Math_Expression_Node.X5, Custom_Math_Expression_Node.X6));
                    break;
                case 6:
                    ListViewModel.AddNodeType(() => new Custom_Math_Expression_ViewModel_7_Input(this, Custom_Math_Expression_Node.Expression_Name, true, (NodeCategory)Custom_Math_Expression_Node.Category, Custom_Math_Expression_Node.Background, Custom_Math_Expression_Node.Foreground, Custom_Math_Expression_Node.Units, Custom_Math_Expression_Node.Using_Fast_Expression_Parsing_Library ? "Fast" : "Slow", Custom_Math_Expression_Node.Expression, Custom_Math_Expression_Node.Output, Custom_Math_Expression_Node.X1, Custom_Math_Expression_Node.X2, Custom_Math_Expression_Node.X3, Custom_Math_Expression_Node.X4, Custom_Math_Expression_Node.X5, Custom_Math_Expression_Node.X6, Custom_Math_Expression_Node.X7));
                    break;
                default:
