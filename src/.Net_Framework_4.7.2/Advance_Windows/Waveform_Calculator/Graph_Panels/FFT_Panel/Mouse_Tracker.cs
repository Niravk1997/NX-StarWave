    ...
    public partial class FFT_Panel : UserControl
    {
        ...
        private void Show_Mouse_Tracker()
        {
            if (MouseTrackerMenuItem.IsChecked)
            {
                ...
                Mouse_Tracker.HorizontalLine.PositionFormatter = y => Axis_Scale_Config.Value_SI_Prefix(y, 0) + Axis_Scale_Config.Y_Axis_Units;
        ...
        private void Graph_MouseMove(object sender, MouseEventArgs e)
        {
            if (ShowMouseTracker == true)
            {
                ...
                MouseCoordinates.Label = Axis_Scale_Config.Value_SI_Prefix(X_MouseCoordinate, 3) + "Hz" + ", " + Axis_Scale_Config.Value_SI_Prefix(Y_MouseCoordinate, 3) + Axis_Scale_Config.Y_Axis_Units;
