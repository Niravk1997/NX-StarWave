    ...
    public partial class FFT_Panel : UserControl
    {
        ...
        private void Add_Clear_Vertical_Markers()
        {
            if (Vertical_Markers_MenuItem.IsChecked == true)
            {
                ...
                Vertical_Start_Marker_Annotation = Graph.Plot.AddAnnotation("V Marker: " + Axis_Scale_Config.Value_SI_Prefix(Vertical_Start_Marker_Value, 4) + "Hz", 5, 20);
                ...
                Vertical_Stop_Marker_Annotation = Graph.Plot.AddAnnotation("V Marker: " + Axis_Scale_Config.Value_SI_Prefix(Vertical_Stop_Marker_Value, 4) + "Hz", 5, 35);
                ...
                Vertical_Marker_FrequencyDifference_Annotation = Graph.Plot.AddAnnotation("∆ Frequency: " + Axis_Scale_Config.Value_SI_Prefix((Vertical_Stop_Marker_Value - Vertical_Start_Marker_Value), 4) + "Hz", 5, 50);
        ...
        private void Add_Clear_Horizontal_Markers()
        {
            if (Horizontal_Markers_MenuItem.IsChecked == true)
            {
                ...
                Horizontal_Marker_MagnitudeDifference_Annotation = Graph.Plot.AddAnnotation("∆ Magnitude: " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_Stop_Marker_Value - Horizontal_Start_Marker_Value, 4) + Y_AXIS_Units, 5, 95);
        ...
        private void Horizontal_Marker_Start_Dragged_Event(object sender, EventArgs eventArgs)
        {
            ...
            Horizontal_Marker_MagnitudeDifference_Annotation.Label = "∆ Magnitude: " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_VoltageDifference_Value, 4) + Y_AXIS_Units;
        }
