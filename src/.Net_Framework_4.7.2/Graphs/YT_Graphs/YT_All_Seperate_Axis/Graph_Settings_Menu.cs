...
namespace YT_All_Seperate_Axis
{
    public partial class YT_All_Seperate_Axis_Plotter : MetroWindow
    {
        ...
        private void Font_Size_12_Click(object sender, RoutedEventArgs e)
        {
            ...
            AxisLine_2.TickLabelStyle(fontSize: 12);
            AxisLine_3.TickLabelStyle(fontSize: 12);
            Graph.Render();
        ...
        private void Font_Size_14_Click(object sender, RoutedEventArgs e)
        {
            ...
            AxisLine_2.TickLabelStyle(fontSize: 14);
            AxisLine_3.TickLabelStyle(fontSize: 14);
            Graph.Render();
        ...
        private void Font_Size_16_Click(object sender, RoutedEventArgs e)
        {
            ...
            AxisLine_2.TickLabelStyle(fontSize: 16);
            AxisLine_3.TickLabelStyle(fontSize: 16);
            Graph.Render();
        ...
        private void Font_Size_18_Click(object sender, RoutedEventArgs e)
        {
            ...
            AxisLine_2.TickLabelStyle(fontSize: 18);
            AxisLine_3.TickLabelStyle(fontSize: 18);
            Graph.Render();
