...
namespace YT_All_Seperate_Axis
{
    public partial class YT_All_Seperate_Axis_Plotter : MetroWindow
    {
        ...
        {
            Color CH1 = Channel_1_Curve.Color;
            Color CH2 = Channel_2_Curve.Color;
            Color CH3 = Channel_3_Curve.Color;
            Color CH4 = Channel_4_Curve.Color;
            Graph.Plot.Style(ScottPlot.Style.Default);
            Graph.Plot.YAxis.Color(CH1);
            Graph.Plot.YAxis2.Color(CH3);
            AxisLine_2.Color(CH2);
            AxisLine_3.Color(CH4);
            Theme_Select(0);
