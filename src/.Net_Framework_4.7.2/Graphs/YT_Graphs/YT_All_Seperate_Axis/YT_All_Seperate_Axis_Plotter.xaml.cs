...
namespace YT_All_Seperate_Axis
{
    public partial class YT_All_Seperate_Axis_Plotter : MetroWindow
    {
        ...
        private ScottPlot.Renderable.Axis AxisLine_2;
        private ScottPlot.Renderable.Axis AxisLine_3;
        ...
        public YT_All_Seperate_Axis_Plotter(string Title, string Channel_1_Color, string Channel_2_Color, string Channel_3_Color, string Channel_4_Color)
        {
            InitializeComponent();
            DataContext = this;
        ...
        public void Initialize_Waveform_Curve(string Channel_1_Color, string Channel_2_Color, string Channel_3_Color, string Channel_4_Color)
        {
            ...
            Graph.Plot.YAxis.Color(System.Drawing.ColorTranslator.FromHtml(Channel_1_Color));
            Graph.Plot.YAxis2.IsVisible = true;
            Graph.Plot.YAxis2.Ticks(true);
            Graph.Plot.YAxis2.Color(System.Drawing.ColorTranslator.FromHtml(Channel_3_Color));
            AxisLine_2 = Graph.Plot.AddAxis(ScottPlot.Renderable.Edge.Left, 2, color: System.Drawing.ColorTranslator.FromHtml(Channel_2_Color));
            AxisLine_3 = Graph.Plot.AddAxis(ScottPlot.Renderable.Edge.Right, 3, color: System.Drawing.ColorTranslator.FromHtml(Channel_4_Color));

            Graph.Plot.YAxis.TickMarkDirection(false);
            Graph.Plot.YAxis2.TickMarkDirection(false);
            AxisLine_2.TickMarkDirection(false);
            AxisLine_3.TickMarkDirection(false);

            Channel_1_Curve = Graph.Plot.AddSignalXY(CH1_X_Values, CH1_Y_Values, color: System.Drawing.ColorTranslator.FromHtml(Channel_1_Color), label: "CH1");
            Channel_1_Curve.MarkerSize = 1;
            Channel_1_Curve.MaxRenderIndex = 0;
            Channel_1_Curve.YAxisIndex = 0;

            Channel_2_Curve = Graph.Plot.AddSignalXY(CH2_X_Values, CH2_Y_Values, color: System.Drawing.ColorTranslator.FromHtml(Channel_2_Color), label: "CH2");
            Channel_2_Curve.MarkerSize = 1;
            Channel_2_Curve.MaxRenderIndex = 0;
            Channel_2_Curve.YAxisIndex = 2;

            Channel_3_Curve = Graph.Plot.AddSignalXY(CH3_X_Values, CH3_Y_Values, color: System.Drawing.ColorTranslator.FromHtml(Channel_3_Color), label: "CH3");
            Channel_3_Curve.MarkerSize = 1;
            Channel_3_Curve.MaxRenderIndex = 0;
            Channel_3_Curve.YAxisIndex = 1;

            Channel_4_Curve = Graph.Plot.AddSignalXY(CH4_X_Values, CH4_Y_Values, color: System.Drawing.ColorTranslator.FromHtml(Channel_4_Color), label: "CH4");
            Channel_4_Curve.MarkerSize = 1;
            Channel_4_Curve.MaxRenderIndex = 0;
            Channel_4_Curve.YAxisIndex = 3;
