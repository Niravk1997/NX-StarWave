...
namespace AllChannels_YT_Square
{
    public partial class AllChannels_YT_Square_Plotter : MetroWindow
    {
        private void Graph_Orientation_1_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph_2.SetValue(Grid.ColumnProperty, 0);

            Graph_3.SetValue(Grid.RowProperty, 0);
            Graph_3.SetValue(Grid.ColumnProperty, 2);
        ...
        {
            Graph_2.SetValue(Grid.RowProperty, 0);
            Graph_2.SetValue(Grid.ColumnProperty, 2);

            Graph_3.SetValue(Grid.RowProperty, 2);
            Graph_3.SetValue(Grid.ColumnProperty, 0);
        ...
        {
            Graph_1.Plot.Title(Title_Set_Text.Text);
            Graph_1.Render();
        ...
        {
            Graph_1.Plot.XAxis.Label(X_Axis_Set_Text.Text);
            Graph_1.Render();
        ...
        private void X_Axis_Show_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Graph_1.Plot.XAxis.Ticks(true);
                Graph_1.Render();
                Graph_2.Plot.XAxis.Ticks(true);
                Graph_2.Render();
                Graph_3.Plot.XAxis.Ticks(true);
                Graph_3.Render();
                Graph_4.Plot.XAxis.Ticks(true);
                Graph_4.Render();
                Insert_Log("Graph's X-Axis Ticks have been enabled.", 0);
            }
            else
            {
                Graph_1.Plot.XAxis.Ticks(false);
                Graph_1.Render();
                Graph_2.Plot.XAxis.Ticks(false);
                Graph_2.Render();
                Graph_3.Plot.XAxis.Ticks(false);
                Graph_3.Render();
                Graph_4.Plot.XAxis.Ticks(false);
                Graph_4.Render();
        ...
        {
            Graph_1.Plot.XAxis.TickLabelStyle(rotation: 0);
            Graph_1.Render();
            Graph_2.Plot.XAxis.TickLabelStyle(rotation: 0);
            Graph_2.Render();
            Graph_3.Plot.XAxis.TickLabelStyle(rotation: 0);
            Graph_3.Render();
            Graph_4.Plot.XAxis.TickLabelStyle(rotation: 0);
            Graph_4.Render();
        ...
        {
            Graph_1.Plot.XAxis.TickLabelStyle(rotation: 45);
            Graph_1.Render();
            Graph_2.Plot.XAxis.TickLabelStyle(rotation: 45);
            Graph_2.Render();
            Graph_3.Plot.XAxis.TickLabelStyle(rotation: 45);
            Graph_3.Render();
            Graph_4.Plot.XAxis.TickLabelStyle(rotation: 45);
            Graph_4.Render();
        ...
        {
            Graph_1.Plot.XAxis.TickLabelStyle(rotation: 90);
            Graph_1.Render();
            Graph_2.Plot.XAxis.TickLabelStyle(rotation: 90);
            Graph_2.Render();
            Graph_3.Plot.XAxis.TickLabelStyle(rotation: 90);
            Graph_3.Render();
            Graph_4.Plot.XAxis.TickLabelStyle(rotation: 90);
            Graph_4.Render();
        ...
        {
            Graph_1.Plot.XAxis.TickLabelStyle(rotation: 135);
            Graph_1.Render();
            Graph_2.Plot.XAxis.TickLabelStyle(rotation: 135);
            Graph_2.Render();
            Graph_3.Plot.XAxis.TickLabelStyle(rotation: 135);
            Graph_3.Render();
            Graph_4.Plot.XAxis.TickLabelStyle(rotation: 135);
            Graph_4.Render();
        ...
        {
            Graph_1.Plot.XAxis.TickLabelStyle(rotation: 180);
            Graph_1.Render();
            Graph_2.Plot.XAxis.TickLabelStyle(rotation: 180);
            Graph_2.Render();
            Graph_3.Plot.XAxis.TickLabelStyle(rotation: 180);
            Graph_3.Render();
            Graph_4.Plot.XAxis.TickLabelStyle(rotation: 180);
            Graph_4.Render();
