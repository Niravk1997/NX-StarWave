    ...
    public partial class YT_Plotter : MetroWindow
    {
        ...
        private void Enable_Disable_Gated_HighestPoints_Click(object sender, RoutedEventArgs e)
        {
            if (Gated_HighestPoints_EnableDisable_MenuItem.IsChecked)
            {
                ...
                Gated_HighestPoints_Start_Plot_Marker.PositionFormatter = x => "HS: " + Axis_Scale_Config.Value_SI_Prefix(x, 2) + "s";
                ...
                Gated_HighestPoints_Stop_Plot_Marker.PositionFormatter = x => "HE: " + Axis_Scale_Config.Value_SI_Prefix(x, 2) + "s";
                ...
                if (Gated_HighestPoints_Table != null & Gated_HighestPoints_IsEnabled)
                {
                    try
                    {
                        Gated_HighestPoints_Table.Measurement_Start = Axis_Scale_Config.Value_SI_Prefix(this.Gated_HighestPoints_Start_Value, 2) + "s";
                        Gated_HighestPoints_Table.Measurement_Stop = Axis_Scale_Config.Value_SI_Prefix(this.Gated_HighestPoints_Stop_Value, 2) + "s";
                    }
                    catch (Exception) { }
                }
            }
        ...
        private void Disable_Gated_HighestPoints()
        {
            ...
            Close_Gated_HighestPoints_Table_Window();
        ...
        private void Open_Gated_HighestPoints_Table_Window()
        {
            ...
            {
                Gated_HighestPoints_Table = new Gated_Peaks_Table_Window(Channel_Title + " YT Gated Highest Points ", Waveform_Curve.Color, "Magnitude", "Time (s)", Measurement_Unit, "s", Gated_HighestPoints_Panel_FloatingHeight, Gated_HighestPoints_Panel_FloatingWidth, true, true);
        ...
        private void Close_Gated_HighestPoints_Table_Window()
        {
            try
            {
                if (Gated_HighestPoints_Table != null)
