    ...
    public partial class AllChannels_YT_Plotter : MetroWindow
    {
        ...
        private void Show_Tracker_Click(object sender, RoutedEventArgs e)
        {
            if (Show_Tracker.IsChecked == true)
            {
                ...
                Mouse_Tracker.VerticalLine.PositionFormatter = x => Axis_Scale_Config.Value_SI_Prefix(x, 0) + "s";
                Mouse_Tracker.HorizontalLine.PositionFormatter = y => Axis_Scale_Config.Value_SI_Prefix(y, 0) + CH1_Measurement_Unit;
        ...
        private void Graph_MouseMove(object sender, MouseEventArgs e)
        {
            if (ShowMouseTracker == true)
            {
                ...
                if (ShowMouseCoordinates == true)
                {
                    MouseCoordinates.Label = Axis_Scale_Config.Value_SI_Prefix(X_MouseCoordinate, 4) + "s, " + Axis_Scale_Config.Value_SI_Prefix(Y_MouseCoordinate, 4) + CH1_Measurement_Unit;
