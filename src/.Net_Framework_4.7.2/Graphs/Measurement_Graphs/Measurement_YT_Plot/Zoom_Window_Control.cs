...
namespace Measurement_Plot
{
    public partial class Measurement_Plot_Window : MetroWindow
    {
        ...
        private ScottPlot.Plottable.SignalPlotXY Zoom_Waveform_Curve = null;
        ...
        private void Enable_Zoom_Control()
        {
            ...
            Measurement_Plot_Grid.Children.Add(Zoom_Control_Plot);
        ...
        private void Disable_Zoom_Control()
        {
            ...
            Measurement_Plot_Grid.Children.Remove(Zoom_Control_Plot);
        ...
        {
            Zoom_Waveform_Curve = Zoom_Control_Plot.Plot.AddSignalXY(Date_Time, Measurement_Data, color: Measurement_Plot.Color, label: null);
            Zoom_Waveform_Curve.MarkerSize = 0;
            Zoom_Waveform_Curve.MaxRenderIndex = Measurement_Data_Count - 1;
        }
