...
namespace Channel_DataLogger
{
    public partial class Math_Waveform : MetroWindow
    {
            ...
            if (isValidGraphColor == true & isValid == true)
            {
                ...
                Task.Run(() =>
                {
                    try
                    {
                        ...
                        Create_Waveform_Window("(Value)^(Samples) Math Waveform [All Samples]", Value, 0, Measurement_Count_Copy - 1, Graph_Title, Y_Axis_Title, Value_Red, Value_Green, Value_Blue, Measurement_Data_Copy, Measurement_Count_Copy);
                        Measurement_Data_Copy = null;
            ...
            if (isValidGraphColor == true & isValid == true)
            {
                ...
                Task.Run(() =>
                {
                    try
                    {
                        ...
                        Create_Waveform_Window("(Samples)^(Value) Math Waveform [All Samples]", Value, 0, Measurement_Count_Copy - 1, Graph_Title, Y_Axis_Title, Value_Red, Value_Green, Value_Blue, Measurement_Data_Copy, Measurement_Count_Copy);
                        Measurement_Data_Copy = null;
        ...
        private void Set_Default_GraphColor_Math_AllSamples(int Red, int Green, int Blue)
        {
            GraphColor_Preview_Math_AllSamples.SelectedColor = System.Windows.Media.Color.FromRgb((byte)Red, (byte)Green, (byte)Blue);
        }
