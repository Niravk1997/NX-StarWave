...
namespace FFT_Waterfall
{
    public partial class FFT_Waterfall_Plotter : MetroWindow
    {
        ...
        private MenuItem AxisMatch_MenuItem;
        ...
        private void Initialize_Right_Click_Menu()
        {
            ...
            AxisMatch_MenuItem = new MenuItem() { Header = "Axis Match" };
            AxisMatch_MenuItem.Click += Right_Click_AxisMatch;
            AxisMatch_MenuItem.IsCheckable = true;
            AxisMatch_MenuItem.IsChecked = true;
            ...
            rightClickMenu.Items.Add(AxisMatch_MenuItem);
