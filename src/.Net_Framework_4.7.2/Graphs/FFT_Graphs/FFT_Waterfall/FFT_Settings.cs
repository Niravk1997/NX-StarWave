...
namespace FFT_Waterfall
{
    public partial class FFT_Waterfall_Plotter : MetroWindow
    {
        ...
        private void Y_AXIS_V_Click(object sender, RoutedEventArgs e)
        {
            ...
            Axis_Scale_Config.Y_Axis_Units = Y_AXIS_Units_Custom;
            Set_Gated_Highest_Points_Units(Y_AXIS_Units_Custom);
            Set_Gated_Peaks_Units(Y_AXIS_Units_Custom);
            Graph.Plot.YAxis2.Label("Magnitude (Linear " + Y_AXIS_Units_Custom + "rms)");
        }
