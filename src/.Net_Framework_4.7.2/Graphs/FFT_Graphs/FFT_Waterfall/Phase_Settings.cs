    ...
    public partial class FFT_Waterfall_Plotter : MetroWindow
    {
        ...
        private void Show_Phase_Option_Click(object sender, RoutedEventArgs e)
        {
            if (Calculate_Phase)
            {
                ...
                Graph.Plot.YAxis.Label(Phase_Y_AXIS_Label);
                Phase_Waveform.IsVisible = true;

                Graph.Plot.Layout(left: 70, right: 100, bottom: 0, top: 0, padding: 0);
                Waterfall.Plot.Layout(left: 70, bottom: 0, padding: 0);
            ...
            else
            {
                ...
                Graph.Plot.YAxis.Label(string.Empty);
