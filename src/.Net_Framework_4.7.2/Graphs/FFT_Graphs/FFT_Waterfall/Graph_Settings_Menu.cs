...
namespace FFT_Waterfall
{
    public partial class FFT_Waterfall_Plotter : MetroWindow
    {
        ...
        {
            Graph.Plot.YAxis2.Label(Y_Axis_Set_Text.Text);
            Graph.Render();
        ...
        {
            Graph.Plot.YAxis2.TickLabelStyle(rotation: 0);
            Graph.Render();
        ...
        {
            Graph.Plot.YAxis2.TickLabelStyle(rotation: 45);
            Graph.Render();
        ...
        {
            Graph.Plot.YAxis2.TickLabelStyle(rotation: 90);
            Graph.Render();
        ...
        {
            Graph.Plot.YAxis2.TickLabelStyle(rotation: 135);
            Graph.Render();
        ...
        {
            Graph.Plot.YAxis2.TickLabelStyle(rotation: 180);
            Graph.Render();
        ...
        private void Y_Axis_Tick_Ruler_Mode_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Graph.Plot.YAxis2.RulerMode(true);
                Graph.Render();
                Insert_Log("Graph's Y-Axis Ruler Mode is Enabled.", 0);
            }
            else
            {
                Graph.Plot.YAxis2.RulerMode(false);
                Graph.Render();
