...
namespace FFT_Waterfall
{
    public partial class FFT_Waterfall_Plotter : MetroWindow
    {
        ...
        private void Add_Clear_Horizontal_Markers()
        {
            ...
            {
                AxisLimits Graph_Axis_Limits = Graph.Plot.GetAxisLimits(0, 1);
                Horizontal_Start_Marker = Graph.Plot.AddHorizontalLine(Graph_Axis_Limits.YCenter, color: System.Drawing.ColorTranslator.FromHtml("#FF00950E"), style: ScottPlot.LineStyle.DashDot, label: "H Marker");
                Horizontal_Start_Marker.YAxisIndex = 1;
                ...
                Horizontal_Stop_Marker = Graph.Plot.AddHorizontalLine(Graph_Axis_Limits.YCenter, color: System.Drawing.ColorTranslator.FromHtml("#FFFF0000"), style: ScottPlot.LineStyle.DashDot, label: "H Marker");
                Horizontal_Stop_Marker.YAxisIndex = 1;
