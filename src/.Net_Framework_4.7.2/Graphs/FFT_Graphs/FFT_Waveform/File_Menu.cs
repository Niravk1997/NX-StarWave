    ...
    public partial class FFT_Waveform_Plotter : MetroWindow
    {
        private void Save_Data_Text_File_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    FileName = "Waveform_FFT_Data" + "_" + DateTime.Now.ToString("yyyy-MM-dd h-mm-ss tt") + ".txt",
        ...
        private void Save_Data_CSV_File_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var Save_Data_Text_Window = new SaveFileDialog
                {
                    FileName = "Waveform_FFT_Data" + "_" + DateTime.Now.ToString("yyyy-MM-dd h-mm-ss tt") + ".csv",
