...
namespace FFT_Waveform
{
    public partial class FFT_Waveform_Plotter : MetroWindow
    {
        ...
        //Select whether to show oscilloscope's Voltage data or fft window data
        private bool Show_Oscilloscope_Data = true;

        private void Show_FFT_Waveform_Click(object sender, RoutedEventArgs e)
        {
            if (Show_FFT_Option.IsChecked)
            {
                FFT_Waveform.IsVisible = true;
                Graph.Render();
            }
            else
            {
                FFT_Waveform.IsVisible = false;
                Graph.Render();
            }
        }
        ...
        private void Y_AXIS_dbV_Click(object sender, RoutedEventArgs e)
        {
            ...
            Set_Gated_Highest_Points_Units("dB");
            Set_Gated_Peaks_Units("dB");
        ...
        private void Y_AXIS_V_Click(object sender, RoutedEventArgs e)
        {
            ...
            Set_Gated_Highest_Points_Units("V");
            Set_Gated_Peaks_Units("V");
            Graph.Plot.YAxis.Label("Magnitude (Linear Vrms)");
        }

        private void Waveform_Show_Oscilloscope_Data_Click(object sender, RoutedEventArgs e)
        {
            Show_Oscilloscope_Data = true;
            Waveform_Show_Oscilloscope_Data.IsChecked = true;
            Waveform_Show_FFT_Window_Data.IsChecked = false;
        }

        private void Waveform_Show_FFT_Window_Data_Click(object sender, RoutedEventArgs e)
        {
            Show_Oscilloscope_Data = false;
            Waveform_Show_FFT_Window_Data.IsChecked = true;
            Waveform_Show_Oscilloscope_Data.IsChecked = false;
        }
