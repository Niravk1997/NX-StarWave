...
namespace Anytime_Histogram
{
    public partial class Histogram : MetroWindow
    {
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FF00FF17");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#0072BD");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FFFF0000");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF00");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FFFF8C00");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FF000000");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FFFF1493");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FF9400D3");
            Graph.Render();
        ...
        {
            Histogram_Plot.FillColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFFFF");
            Graph.Render();
