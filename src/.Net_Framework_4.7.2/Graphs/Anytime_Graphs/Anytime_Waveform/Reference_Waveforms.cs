    ...
    public partial class Waveform : MetroWindow
    {
        ...
        private void Copy_Reference_Data_Clipboard()
        {
            try
            {
                ...
                Reference_Waveform Reference_Waveform = new Reference_Waveform(Y_Waveform_Values, Data_Points, Total_Time, Start_Time, Stop_Time, Label, System.Drawing.ColorTranslator.ToHtml(Waveform_Curve.Color));
