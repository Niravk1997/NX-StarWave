    ...
    public partial class Waveform : MetroWindow
    {
        ...
        private void Add_Clear_Vertical_Markers()
        {
            if (Vertical_Markers_MenuItem.IsChecked == true & Draggable_Vertical_Markers.IsChecked == true)
            {
                ...
                Period_Label = Axis_Scale_Config.Value_SI_Prefix(Math.Abs(Vertical_Stop_Marker_Value - Vertical_Start_Marker_Value), 4) + "s";
                Frequency_Label = Axis_Scale_Config.Value_SI_Prefix(1 / Math.Abs(Vertical_Stop_Marker_Value - Vertical_Start_Marker_Value), 4) + "Hz";
                Graph.Render();
            }
            else
            {
        ...
        private void Vertical_Marker_Start_Dragged_Event(object sender, EventArgs eventArgs)
        {
            ...
            Period_Label = Axis_Scale_Config.Value_SI_Prefix(Vertical_TimeDifference_Value, 4) + "s";
            Frequency_Label = Axis_Scale_Config.Value_SI_Prefix(1 / Vertical_TimeDifference_Value, 4) + "Hz";
        }
        ...
        private void Add_Clear_Horizontal_Markers()
        {
            if (Horizontal_Markers_MenuItem.IsChecked == true & Draggable_Horizontal_Markers.IsChecked == true)
            {
                ...
                Horizontal_Start_Marker_Annotation = Graph.Plot.AddAnnotation("H Marker: " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_Start_Marker_Value, 4) + YAxis_Units, 5, 55);
                ...
                Horizontal_Stop_Marker_Annotation = Graph.Plot.AddAnnotation("H Marker: " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_Stop_Marker_Value, 4) + YAxis_Units, 5, 70);
                ...
                Horizontal_Marker_VoltageDifference_Annotation = Graph.Plot.AddAnnotation("∆ : " + Axis_Scale_Config.Value_SI_Prefix((Horizontal_Stop_Marker_Value - Horizontal_Start_Marker_Value), 4) + YAxis_Units, 5, 85);
                ...
                Horizontal_VoltageDifference_Label.Content = Axis_Scale_Config.Value_SI_Prefix(Math.Abs(Horizontal_Stop_Marker_Value - Horizontal_Start_Marker_Value), 4) + YAxis_Units;

                Horizontal_Green_Label.Content = Axis_Scale_Config.Value_SI_Prefix(Horizontal_Start_Marker.Y, 4) + YAxis_Units;
                Horizontal_Red_Label.Content = Axis_Scale_Config.Value_SI_Prefix(Horizontal_Stop_Marker.Y, 4) + YAxis_Units;
                Graph.Render();
            }
            else
            {
        ...
        {
            double Horizontal_Start_Marker_Value = Horizontal_Start_Marker.Y;
            Horizontal_Start_Marker_Annotation.Label = "H Marker: " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_Start_Marker_Value, 4) + YAxis_Units;
            Horizontal_Green_Label.Content = Axis_Scale_Config.Value_SI_Prefix(Horizontal_Start_Marker_Value, 4) + YAxis_Units;

            double Horizontal_VoltageDifference_Value = Math.Abs(Horizontal_Stop_Marker.Y - Horizontal_Start_Marker_Value);
            Horizontal_VoltageDifference_Label.Content = Axis_Scale_Config.Value_SI_Prefix(Horizontal_VoltageDifference_Value, 4) + YAxis_Units;
            Horizontal_Marker_VoltageDifference_Annotation.Label = "∆ : " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_VoltageDifference_Value, 4) + YAxis_Units;
        }

        private void Horizontal_Marker_Stop_Dragged_Event(object sender, EventArgs eventArgs)
        {
            double Horizontal_Stop_Marker_Value = Horizontal_Stop_Marker.Y;
            Horizontal_Stop_Marker_Annotation.Label = "H Marker: " + Axis_Scale_Config.Value_SI_Prefix(Horizontal_Stop_Marker.Y, 4) + YAxis_Units;
            Horizontal_Red_Label.Content = Axis_Scale_Config.Value_SI_Prefix(Horizontal_Stop_Marker_Value, 4) + YAxis_Units;
