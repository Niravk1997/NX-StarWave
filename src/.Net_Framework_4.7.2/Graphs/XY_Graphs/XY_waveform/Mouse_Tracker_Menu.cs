    ...
    public partial class XY_Waveform_Plotter : MetroWindow
    {
        ...
        private void Show_Tracker_Click(object sender, RoutedEventArgs e)
        {
            if (Show_Tracker.IsChecked == true)
            {
                ...
                Mouse_Tracker.VerticalLine.PositionFormatter = x => Axis_Scale_Config.Value_SI_Prefix(x, 0) + "V";
                Mouse_Tracker.HorizontalLine.PositionFormatter = x => Axis_Scale_Config.Value_SI_Prefix(x, 0) + "V";
        ...
        private void Graph_MouseMove(object sender, MouseEventArgs e)
        {
            if (ShowMouseTracker == true)
            {
                ...
                if (ShowMouseCoordinates == true)
                {
                    MouseCoordinates.Label = Axis_Scale_Config.Value_SI_Prefix(X_MouseCoordinate, 4) + "V, " + Axis_Scale_Config.Value_SI_Prefix(Y_MouseCoordinate, 4) + "V";
