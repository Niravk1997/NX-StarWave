...
namespace XY_Waveform
{
    public partial class XY_Waveform_Plotter : MetroWindow
    {
        ...
        private void Font_Size_12_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Plot.YAxis2.TickLabelStyle(fontSize: 12);
            Waveform_Graph.Plot.XAxis.TickLabelStyle(fontSize: 12);
            Waveform_Graph.Plot.YAxis.TickLabelStyle(fontSize: 12);
            Graph.Render();
        ...
        private void Font_Size_14_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Plot.YAxis2.TickLabelStyle(fontSize: 14);
            Waveform_Graph.Plot.XAxis.TickLabelStyle(fontSize: 14);
            Waveform_Graph.Plot.YAxis.TickLabelStyle(fontSize: 14);
            Graph.Render();
            Waveform_Graph.Render();
        ...
        private void Font_Size_16_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Plot.YAxis2.TickLabelStyle(fontSize: 16);
            Waveform_Graph.Plot.XAxis.TickLabelStyle(fontSize: 16);
            Waveform_Graph.Plot.YAxis.TickLabelStyle(fontSize: 16);
            Graph.Render();
            Waveform_Graph.Render();
        ...
        private void Font_Size_18_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Plot.YAxis2.TickLabelStyle(fontSize: 18);
            Waveform_Graph.Plot.XAxis.TickLabelStyle(fontSize: 18);
            Waveform_Graph.Plot.YAxis.TickLabelStyle(fontSize: 18);
            Graph.Render();
            Waveform_Graph.Render();
        ...
        private void Show_legend_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                Waveform_Graph.Plot.Legend(false);
                Graph.Render();
                Waveform_Graph.Render();
        ...
        private void Legend_TopLeft_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Render();
            Waveform_Graph.Plot.Legend(location: Alignment.UpperLeft);
            Waveform_Graph.Render();
        ...
        private void Legend_TopRight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Render();
            Waveform_Graph.Plot.Legend(location: Alignment.UpperRight);
            Waveform_Graph.Render();
        ...
        private void Legend_BottomLeft_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Render();
            Waveform_Graph.Plot.Legend(location: Alignment.LowerLeft);
            Waveform_Graph.Render();
        ...
        private void Legend_BottomRight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph.Render();
            Waveform_Graph.Plot.Legend(location: Alignment.LowerRight);
            Waveform_Graph.Render();
            Insert_Log("Graph's Legend is now located at Bottom Left Side.", 0);
            Legend_TopLeft.IsChecked = false;
            Legend_TopRight.IsChecked = false;
