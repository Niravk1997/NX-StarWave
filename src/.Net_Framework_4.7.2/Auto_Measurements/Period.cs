...
namespace Auto_Measurements
{
    ...
    {
        internal double Period(double[] X_Waveform_Values, double[] Y_Waveform_Values, int Data_Points, double Waveform_Max, double Waveform_Min)
        {
        ...
        internal double Period(double Frequency)
        {
            if (Frequency == 0)
            {
                return 0;
